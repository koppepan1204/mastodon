...
class ComposeForm extends ImmutablePureComponent {
  ...
  handleSubmit = () => {
    ...
    if (is_submitting || is_uploading || length(fulltext) > 99999 || (fulltext.length !== 0 && fulltext.trim().length === 0 && !anyMedia)) {
      return;
    }
  ...
  render () {
    ...
    const disabledButton = disabled || this.props.is_uploading || length(text) > 99999 || (text.length !== 0 && text.trim().length === 0 && !anyMedia);
    let publishText = '';
    ...
    return (
      <div className='compose-form'>
        ...
        <div className='compose-form__buttons-wrapper'>
          ...
          <div className='character-counter__wrapper'><CharacterCounter max={99999} text={text} /></div>
        </div>
